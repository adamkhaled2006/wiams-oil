...
-- مهم: بدّل your-email@example.com بإيميل الأدمن الحقيقي
...
insert into public.store_settings (
  id, store_name, tagline, hero_title, hero_subtitle, whatsapp_number, primary_color, accent_color
)
values (
  1,
  'متجر ويام',
...
stable
as $$
  select auth.email() = 'your-email@example.com';
$$;
