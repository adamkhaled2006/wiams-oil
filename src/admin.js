        ...
        <section class="stack" style="gap:18px">
          <section class="panel admin-tab" data-panel="dashboard">
            ...
            <div class="note-card" style="margin-top:14px">
              ...
              <div class="muted">المنتجات، الطلبات، نصوص الواجهة، الألوان، الواتساب، والإيميل التلقائي.</div>
            </div>
          </section>
          ...
          <section class="panel admin-tab hidden" data-panel="orders">
            ...
            <div class="note-card" style="margin-bottom:14px">
              <strong>الإيميل والواتساب</strong>
              <div class="muted">كل طلب ينحفظ هنا. والإيميل التلقائي يحتاج Edge Function + Resend. والواتساب يظهر للزبون بعد الطلب.</div>
            </div>
          ...
          <section class="panel admin-tab hidden" data-panel="contact">
            ...
            <form class="stack" id="contactForm">
              ...
              <input class="input" name="notify_email" placeholder="إيميل استقبال الطلبات" value="adamkhaled999oooo@gmail.com" disabled>
              <div class="muted">الإيميل التلقائي مضبوط على: adamkhaled999oooo@gmail.com</div>
              <button class="btn" type="submit">حفظ الواتساب</button>
            </form>
          </section>
        </section>
      </div>
...
async function saveSettingsPartial(form) {
  ...
  if (error) return showToast(els.toast, "فشل حفظ الإعدادات");
  settings = payload;
  fillSettingsForms();
